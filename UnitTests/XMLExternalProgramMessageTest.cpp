...
const boost::filesystem::path xmlFileName = "./externalProgramMessage.xml";
#if defined( _WIN32 )
	const boost::filesystem::path schemaDefinitionFilePath = "../../UnitTests/TestExternalProgramMessageSchema.xsd";
...
*/
bool Utilitites::XMLTest::XMLExternalProgramMessageTest::Test()
{
	using namespace std;

	External::ExternalProgram::CXMLSerializableExternalProgramMessage setMessage, getMessage;

	setMessage.Set( "python.exe", "\"arg 1\" \"$CODE\"" );
