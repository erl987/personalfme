...
reference_file_path = 'data/iir-filter-high-fc.json'
...
reference_file_path = 'data/fir-filter-up-sampling.json'
...
reference_file_path = 'data/iir-filter-up-sampling.json'
down_sampling_factor = 1
up_sampling_factor = 3
is_fir = False
a = 1
...
reference_file_path = 'data/fir-filter-high-fc.json'
down_sampling_factor = 1
...
reference_file_path = 'data/fir-filter-low-fc.json'
down_sampling_factor = 1
up_sampling_factor = 1
is_fir = True
a = 1
...
reference_file_path = 'data/iir-filter-low-fc.json'
down_sampling_factor = 1
up_sampling_factor = 1
is_fir = False
...
reference_file_path = 'data/fir-filter-down-sampling.json'
down_sampling_factor = 3
up_sampling_factor = 1
is_fir = True
a = 1
...
reference_file_path = 'data/iir-filter-down-sampling.json'
down_sampling_factor = 3
up_sampling_factor = 1
is_fir = False
...
reference_file_path = 'data/fir-filter-re-sampling.json'
down_sampling_factor = 3
up_sampling_factor = 2
is_fir = True
a = 1
...
reference_file_path = 'data/iir-filter-re-sampling.json'
down_sampling_factor = 3
up_sampling_factor = 2
is_fir = False
b, a = cheby1(8, 0.05, 0.5333)
...
reference_file_path = 'data/filter-design.json'
down_sampling_factor = 3
