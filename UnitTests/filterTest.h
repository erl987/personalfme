...
namespace FilterTests {
    ...
    */
    ...
    /** @brief		Performing the CFilter-testing for IIR filters
    *	@param		signal	                The test data
    *	@param		a                       The a filter coefficients
    *	@param		b                       The b filter coefficients
    *	@param		downsamplingFactor      The downsampling factor
    *	@param		upsamplingFactor        The upsampling factor
    *	@return								The filtered data
    *	@exception							None
    *	@remarks							None
    */
    std::vector<double> PerformIIRTesting(const std::vector<double>& signal, const std::vector<double>& a, const std::vector<double>& b, int downsamplingFactor, int upsamplingFactor)
    {
        using namespace std;
        ...
        auto filter = std::make_unique<Core::Processing::Filter::CIIRfilter<double>>(a.begin(), a.end(), b.begin(), b.end(), downsamplingFactor, upsamplingFactor);
    ...
    /** @brief		Performing the CFilter-testing for FIR filters
    *	@param		signal	                The test data
    *	@param		b                       The b filter coefficients
    *	@param		downsamplingFactor      The downsampling factor
    *	@param		upsamplingFactor        The upsampling factor
    ...
    *	@remarks							None
    */
    std::vector<double> PerformFIRTesting(const std::vector<double>& signal, const std::vector<double>& b, int downsamplingFactor, int upsamplingFactor)
    {
        using namespace std;
        ...
        auto filter = std::make_unique<Core::Processing::Filter::CFIRfilter<double>>(b.begin(), b.end(), downsamplingFactor, upsamplingFactor);
    ...
    */
    double PerformTesting(std::string referenceDataFileName)
    {
        ...
        if (isFIR) {
            downsampledSignal = PerformFIRTesting(signal, b, downsamplingFactor, upsamplingFactor);
        } else {
            downsampledSignal = PerformIIRTesting(signal, a, b, downsamplingFactor, upsamplingFactor);
        }
