...
const boost::filesystem::path xmlFileName = "./emailLoginData.xml";
#if defined( _WIN32 )
	const boost::filesystem::path schemaDefinitionFilePath = "../../UnitTests/TestEmailLoginDataSchema.xsd";
...
*/
bool Utilitites::XMLTest::XMLEmailLoginDataTest::Test()
{
	External::Email::CXMLSerializableEmailLoginData setLoginData, getLoginData;

	setLoginData.SetConnectionTrialInfos( 7, 19.3f, 5 );
	setLoginData.SetLoginInformation( "First Last <first.last@test.de>", External::Email::UNENCRYPTED_AUTH, "user3", "password10" );
	setLoginData.SetServerInformation( External::Email::TLS_SSL_CONN, "smtp.host.de", 465 );
