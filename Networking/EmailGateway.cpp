...
*	@remarks								None
*/
External::Email::CEmailGateway::CEmailGateway()
	: CAlarmGateway(),
	  privImpl( new CEmailGatewayImpl )
{
}
...
*	@remarks								None
*/
External::Email::CEmailGateway::~CEmailGateway( void )
{
}
...
*	@remarks									None
*/
std::unique_ptr<External::CAlarmGateway> External::Email::CEmailGateway::Clone() const
{
	return std::make_unique<CEmailGateway>();
}
...
*	@remarks								None
*/
void External::Email::CEmailGateway::Send( const std::vector<int>& code, const Utilities::CDateTime& alarmTime, const bool& isRealAlarm, std::unique_ptr<CGatewayLoginData> loginData, std::unique_ptr<CAlarmMessage> message, const Utilities::CMediaFile& audioFile )
{
...
*/
bool External::Email::CEmailGateway::IsEqual( const CAlarmGateway& rhs ) const
{
	try {
		dynamic_cast< const CEmailGateway& >( rhs );
