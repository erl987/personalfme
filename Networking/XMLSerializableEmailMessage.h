...
namespace External {
	namespace Email {
		/** \ingroup Networking
		*	XML-serializable class implementing an e-mail message
		*/
		class CXMLSerializableEmailMessage : public CEmailMessage, public Utilities::XML::CXMLSerializable
		{
		public:
			NETWORKING_API CXMLSerializableEmailMessage() {};
			NETWORKING_API CXMLSerializableEmailMessage( const CEmailMessage& other ) : CEmailMessage( other ) {};
			NETWORKING_API virtual ~CXMLSerializableEmailMessage() {};
