...
namespace External {
	namespace Groupalarm {
		...
		*/
		class CXMLSerializableGroupalarmMessage : public CGroupalarmMessage, public Utilities::XML::CXMLSerializable
		{
		public:
			NETWORKING_API CXMLSerializableGroupalarmMessage() {};
			NETWORKING_API CXMLSerializableGroupalarmMessage( const CGroupalarmMessage& other ) : CGroupalarmMessage( other ) {};
			NETWORKING_API virtual ~CXMLSerializableGroupalarmMessage() {};
